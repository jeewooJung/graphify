    ...
    <div className="page-shell">
      ...
      >
        {isLoadingSession || isLoadingMessages ? (
          <div className="flex min-h-[320px] items-center justify-center rounded-2xl border border-border bg-surface p-6 text-sm text-text-secondary">
            Loading chat...
          </div>
        ) : error ? (
          ...
          <div className="flex min-h-[70vh] flex-col gap-4">
            ...
            <ChatConversation session={session} messages={messages} isStreaming={isSubmitting} onSelectCitation={handleSelectCitation} onFollowUp={handleFollowUp} onNavigate={handleNavigate} />
