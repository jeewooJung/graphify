...
- Name: 09-ui-dashboard.spec.ts >> UI - Dashboard Page >> UI-08: Header search input is visible
- Location: e2e\scenarios\09-ui-dashboard.spec.ts:63:7
...
Locator:  locator('input[type="text"], input[placeholder*="search" i]').first()
Expected: visible
Received: hidden
Timeout:  5000ms
